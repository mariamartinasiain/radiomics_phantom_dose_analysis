...
def main():
    ...
    train_dataset = SmartCacheDataset(data=train_data, transform=transforms,cache_rate=0.01,progress=True,num_init_workers=8, num_replace_workers=8)
    test_dataset = SmartCacheDataset(data=test_data, transform=transforms,cache_rate=0.01,progress=True,num_init_workers=8, num_replace_workers=8)
