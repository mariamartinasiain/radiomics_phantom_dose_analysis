...
def main():
    ...
    train_loader = DataLoader(Dataset(data=train_data, transform=transforms), batch_size=6, shuffle=False,collate_fn=custom_collate_fn)
    test_loader = DataLoader(Dataset(data=test_data, transform=transforms), batch_size=6, shuffle=False,collate_fn=custom_collate_fn)
