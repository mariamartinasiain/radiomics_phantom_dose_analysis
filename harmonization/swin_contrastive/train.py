...
class Train:
    ...
    def train_step(self,batch):
        ...
        if not self.to_compare:
            ...
            self.losses_dict['total_loss'] = \
            self.ortho_reg*self.losses_dict['orthogonality_loss'] + self.losses_dict['contrast_loss'] + self.losses_dict['reconstruction_loss']  
...
def main():
    ...
    trainer = Train(model, data_loader, optimizer, lr_scheduler, 40,dataset,contrastive_latentsize=700,savename="rois_contrastive_ortho_0001.pth",ortho_reg=0.001)
    trainer.train()
