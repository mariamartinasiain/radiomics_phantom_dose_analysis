...
def get_model(target_size = (64, 64, 32)):
    ...
    weight = torch.load("paper_contrastive_{SCANNER_TYPE}_Harmonized_1mGy_IR - #10.pth")
...
def run_inference(model,jsonpath = "./dataset_info_cropped.json"):
    ...
    slice_num = 15
    with open("paper_contrastive_{SCANNER_TYPE}_features2.csv", "w", newline="") as csvfile:
